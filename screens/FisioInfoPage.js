...
const FisioInfoPage = ({ navigation }) => {
  ...
  const renderTitle = (props) => (
    <View style={styles.titleContainer}>
      ...
      />
      <Text {...props}>Fisioterapia Respiratória</Text>
    </View>
  );
    ...
    <>
      ...
      <Layout style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
        <ScrollView style={styles.scrollView}>
          <Text category='s1' style={{ fontSize: 22, }}>O QUE É FISIOTERAPIA RESPIRATÓRIA? oiiiiii</Text>
      ...
      <SafeAreaView style={styles.btmNavBar}>
          <BottomNavigation style={styles.bottomNavigation} {...bottomState}>
            <BottomNavigationTab title='INICIO' icon={HomeIcon} onSelect={() => navigation.navigate('Home')}/>
            <BottomNavigationTab title='SOBRE NÓS' icon={InfoIcon} />
            <BottomNavigationTab title=' EXERCICIOS ' icon={ExercicesIcon} />
            <BottomNavigationTab title=' SABER MAIS' icon={FisioIcon} onSelect={() => navigation.navigate('FisioInfoPage')}/>
